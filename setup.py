...
URL = "https://github.com/zinsy23/open-spirits-arise-equalizer-skill.openvoiceos"
SKILL_CLAZZ = "OpenSpiritsAriseEqualizer"  # needs to match __init__.py class name
PYPI_NAME = "open-spirits-arise-equalizer-skill.openvoiceos"  # pip install PYPI_NAME
...
setup(
    ...
    url=URL,
    author="zinsy23",
    author_email="zinsy23@gmail.com",
    license="Apache-2.0",
